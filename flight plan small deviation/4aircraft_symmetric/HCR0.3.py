...
def st_cst(intruder_pos, own_pos): #for calculation
    ...
    state_cost = np.sum(np.exp(-dist2/1500))
    return state_cost
...
action_cost = [0.1, 0]
init_plan = {'ac1': [[1, 0], [x_range[1] + 100, y_range[1] + 100], [x_range[0], y_range[0]], 45 * math.pi / 180], 'ac2': [[-1, 0], [x_range[1] + 100, y_range[0] - 100], [x_range[0], y_range[1]], -45 * math.pi / 180], 'ac3': [[1, 0], [x_range[0] - 100, y_range[0] - 100], [x_range[1], y_range[1]], 225 * math.pi / 180], 'ac4': [[-1, 0], [x_range[0] - 100, y_range[1] + 100], [x_range[1], y_range[0]], 135 * math.pi / 180]}  # key: name of aircraft, value: [[a,b], a far point in y=ax+b, [init_pos], init_head]
AA, BB, CC, DD = 0.01, 0, 0.03, 0.12
world = Grid(x_range, y_range)
